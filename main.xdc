...
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { buttons[0] }]; #IO_L19P_T3_16 Sch=btn[1]


## Pmod Header JA
# Amp plugs right into this. Pin1 on the amp is Pin1 on the header
# 1: pwm_out
# 2: gain
# 3: Not connected
# 4: shutdown_b
...
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { buttons[3] }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
